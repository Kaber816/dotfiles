...
local menu        = "wofi --show drun --conf ~/.config/wofi/appmenu.conf --style ~/.config/wofi/appmenu.css"
...
hl.bind(mainMod .. " + SHIFT + mouse:273 ", hl.dsp.focus({ workspace = "emptym" }))
